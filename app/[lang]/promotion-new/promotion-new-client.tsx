...
export default function PromotionNewClient() {
        ...
        <section className="py-20 px-6 bg-[#f1f5f9]">
          <div className="max-w-[1100px] mx-auto">
            ...
            <div className="bg-white rounded-[20px] overflow-hidden shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1)] border border-[#e2e8f0]">
              ...
              <div className="p-8">
                <div className="bg-[#f1f5f9] border-2 border-dashed border-[#e2e8f0] rounded-xl p-7 text-center min-h-[200px] flex flex-col items-center justify-center gap-3">
                  <svg className="w-12 h-12 text-[#1a6fc4] opacity-50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>
                  <p className="text-[#64748b] text-[14px]"><strong>{t.live_mockup_text[lang]}</strong></p>
                  <p className="text-[#64748b] text-[14px]">{t.live_mockup_items[lang]}</p>
                </div>
