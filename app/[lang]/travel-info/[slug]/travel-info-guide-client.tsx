          ...
          <div className="grid gap-8 md:grid-cols-4">
            <div>
              <div className="text-sm text-slate-600 leading-relaxed">
                {lang === "en"
                  ? "GoGreeceNow is a travel guide covering destinations, hotels, tours, food and practical travel information for Greece."
                  : "Το GoGreeceNow είναι ένας ταξιδιωτικός οδηγός που καλύπτει προορισμούς, ξενοδοχεία, εκδρομές, φαγητό και πρακτικές πληροφορίες για την Ελλάδα."}
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href={withLang("/about")} className="text-slate-600 hover:text-slate-900">{lang === "en" ? "About" : "Σχετικά"}</Link></li>
                <li><Link href={withLang("/contact")} className="text-slate-600 hover:text-slate-900">{lang === "en" ? "Contact" : "Επικοινωνία"}</Link></li>
                <li><Link href={withLang("/privacy-policy")} className="text-slate-600 hover:text-slate-900">{lang === "en" ? "Privacy Policy" : "Πολιτική Απορρήτου"}</Link></li>
