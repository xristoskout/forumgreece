...
const REAL_PRICING: RealPricing = {
  santorini: {
    ...
    best_for: ["couples", "honeymoon", "photography", "wine", "food_lovers", "luxury", "history", "culture", "boat_trips", "nature", "unique_beaches", "ancient_ruins"],
    not_ideal_for: ["budget_travel", "families_with_kids", "party", "quiet_holidays", "beach_holiday", "families_with_toddlers", "relaxation_only", "quiet_off_beaten_path"],
    beach_score: 6,
    nightlife_score: 5,
    family_score: 5,
    value_score: 4,
  ...
  heraklion: {
    ...
    crowd_level_sept_oct: "medium_low",
    temp: 26,
    best_for: ["history", "food_lovers", "culture", "city_break", "families", "wine_tourism", "day_trips", "gastronomy"],
    not_ideal_for: ["beach_holiday", "nightlife_seekers", "luxury_resort", "romantic_escape"],
    beach_score: 5,
    nightlife_score: 6,
    family_score: 8,
    value_score: 9,
  ...
  rethymno: {
    ...
    crowd_level_sept_oct: "medium_low",
    temp: 26,
    best_for: ["couples", "families", "history", "food_lovers", "culture", "road_trips", "festivals"],
    not_ideal_for: ["nightlife_seekers", "beach_holiday_only", "luxury_resort"],
    beach_score: 6,
    nightlife_score: 5,
    family_score: 8,
    value_score: 8,
  ...
  lasithi: {
    ...
    crowd_level_sept_oct: "low",
    temp: 26,
    best_for: ["history", "food_lovers", "beaches", "luxury", "road_trips", "nature", "off_beat"],
    not_ideal_for: ["party", "nightlife", "budget_resorts", "short_trips"],
    beach_score: 8,
    nightlife_score: 3,
    family_score: 7,
    value_score: 6,
  ...
  tinos: {
    ...
    crowd_level_may_june: "low_medium",
    crowd_level_sept_oct: "low",
    best_for: ["culture", "food_lovers", "religious_travel", "couples", "off_season", "photography", "village_life", "hiking"],
    not_ideal_for: ["party", "ultra_luxury", "heavy_nightlife", "beach_holiday", "water_sports"],
    beach_score: 6,
    nightlife_score: 3,
    family_score: 7,
    value_score: 9,
  ...
  aegina: {
    ...
    crowd_level_sept_oct: "low",
    temp: 28,
    best_for: ["history", "food_lovers", "couples", "families", "day_trips", "off_season", "hiking", "culture"],
    not_ideal_for: ["party", "ultra_luxury", "heavy_nightlife", "beach_holiday", "water_sports"],
    beach_score: 6,
    nightlife_score: 4,
    family_score: 8,
  ...
  preveza: {
    ...
    crowd_level_may_june: "low_medium",
    crowd_level_sept_oct: "low",
    best_for: ["beaches", "history", "food_lovers", "nature", "families", "off_beaten_path"],
    not_ideal_for: ["nightlife", "luxury_resorts", "island_feel"],
    beach_score: 9,
    nightlife_score: 5,
    family_score: 8,
    value_score: 9,
  ...
  ios: {
    ...
    avg_daily_budget_backpacker: 55,
    avg_daily_budget_midrange: 115,
    avg_daily_budget_luxury: 270,
    airport_transfer: 20,
    crowd_level_july_aug: "high",
    crowd_level_may_june: "medium",
    crowd_level_sept_oct: "low_medium",
    temp: 25,
    best_for: ["party", "nightlife", "young_couples", "beaches", "budget_friendly"],
    not_ideal_for: ["families_with_kids", "quiet_holidays", "luxury_seekers"],
    beach_score: 9,
    nightlife_score: 9,
    family_score: 4,
    value_score: 8,
  ...
  syros: {
    ...
    airport_transfer: 20,
    crowd_level_july_aug: "medium",
    crowd_level_may_june: "medium_low",
    crowd_level_sept_oct: "low",
    temp: 26,
    best_for: ["couples", "food_lovers", "culture", "year_round", "off_beaten_path", "architecture", "festivals", "history"],
    not_ideal_for: ["party", "beach_holiday_only", "all_inclusive", "nightlife_seekers"],
    beach_score: 5,
    nightlife_score: 5,
    family_score: 7,
    value_score: 7,
  ...
  kalymnos: {
    ...
    crowd_level_may_june: "low",
    crowd_level_sept_oct: "low",
    best_for: ["climbing", "adventure", "food", "culture", "beaches", "off_season"],
    not_ideal_for: ["luxury_seekers", "nightlife", "package_tourism"],
    beach_score: 7,
    nightlife_score: 3,
    family_score: 7,
    value_score: 9,
  ...
  karpathos: {
    ...
    crowd_level_may_june: "low",
    crowd_level_sept_oct: "low",
    best_for: ["culture", "hiking", "authentic_greece", "beaches", "nature", "foodies"],
    not_ideal_for: ["nightlife", "luxury_seekers"],
    beach_score: 9,
    nightlife_score: 3,
    family_score: 8,
    value_score: 8,
