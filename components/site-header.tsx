...
export default function SiteHeader() {
  ...
  const t = {
    ...
    travelTools: { en: "Plan Your Trip", el: "Σχεδίασε το Ταξίδι σου" },
    stays: { en: "Stays", el: "Διαμονή" },
    toursExperiences: { en: "Tours & Experiences", el: "Εκδρομές & Εμπειρίες" },
    foodWine: { en: "Food & Wine", el: "Φαγητό & Κρασί" },
    blog: { en: "Blog", el: "Blog" },
    aboutGreece: { en: "About Greece", el: "Η Ελλάδα" },
        ...
        <div className="flex min-h-[78px] items-center justify-between gap-3">
          ...
          >
            <div className="flex h-11 w-11 shrink-0 items-center justify-center sm:h-12 sm:w-12">
              <Image
                src="/images/logo/gogreecenow-logo-v2.webp"
