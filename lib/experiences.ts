...
export const experienceBusinesses: ExperienceBusiness[] = [
  ...
  },
  {
    ...
    badge: "Featured",
    overview: {
      en: "Based in Agia Efimia, Kefalonia Day Trips specialises in premium private and semi-private sailing excursions to Kefalonia, Ithaca, and the island of Atokos. Combining well-maintained sailing yachts, experienced local crews, and carefully designed itineraries, the company has become a preferred choice for visitors who want to experience the Ionian Sea away from the crowds.",
      el: "Με βάση την Αγία Ευφημία, η Kefalonia Day Trips ειδικεύεται σε premium ιδιωτικές και ημι-ιδιωτικές ιστιοπλοϊκές εκδρομές σε Κεφαλονιά, Ιθάκη και το νησί του Άτοκου. Συνδυάζοντας καλά συντηρημένα ιστιοπλοϊκά, έμπειρα τοπικά πληρώματα και προσεκτικά σχεδιασμένα δρομολόγια, η εταιρεία έχει γίνει η προτιμώμενη επιλογή για επισκέπτες που θέλουν να γνωρίσουν το Ιόνιο μακριά από τα πλήθη.",
    },
    description: {
      en: "Kefalonia Day Trips offers private and semi-private sailing experiences for couples, families, and small groups. Unlike large excursion boats, the company focuses on small groups and personalised service.\n\nGuests enjoy spacious sailing yachts, crystal-clear waters, hidden coves, and some of the most beautiful coastlines in Greece. Every cruise includes swimming, snorkeling, paddleboarding, and relaxing under sail.\n\nThe most popular experience is the semi-private sailing cruise from Agia Efimia to Ithaca. This all-inclusive day trip includes three swimming stops, a traditional Greek lunch with local wine and refreshments.\n\nFor those seeking a more exclusive experience, private sailing cruises to Atokos Island are available. Atokos is known for its dramatic cliffs, crystal-clear waters, and the famous Pig Beach. Private charters allow guests to customise their itinerary.\n\nThe company operates a fleet of well-maintained sailing yachts with experienced local skippers who are passionate about sharing the beauty of their islands.",
      el: "Η Kefalonia Day Trips προσφέρει ιδιωτικές και ημι-ιδιωτικές ιστιοπλοϊκές εμπειρίες για ζευγάρια, οικογένειες και μικρές παρέες. Σε αντίθεση με τα μεγάλα εκδρομικά πλοία, η εταιρεία εστιάζει σε μικρές ομάδες και εξατομικευμένες υπηρεσίες.\n\nΟι επισκέπτες απολαμβάνουν ευρύχωρα ιστιοπλοϊκά, κρυστάλλινα νερά, κρυφούς όρμους και μερικές από τις πιο όμορφες ακτές της Ελλάδας. Κάθε κρουαζιέρα περιλαμβάνει κολύμπι, snorkeling, paddleboarding και χαλάρωση.\n\nΗ πιο δημοφιλής εμπειρία είναι η ημι-ιδιωτική κρουαζιέρα από την Αγία Ευφημία προς την Ιθάκη, με τρεις στάσεις για κολύμπι και παραδοσιακό ελληνικό γεύμα.\n\nΓια όσους αναζητούν κάτι πιο αποκλειστικό, διατίθενται ιδιωτικές κρουαζιέρες στο νησί του Άτοκου, γνωστό για τους γκρεμούς, τα κρυστάλλινα νερά και το Pig Beach.\n\nΗ εταιρεία διαθέτει έναν στόλο από καλά συντηρημένα ιστιοπλοϊκά με έμπειρους τοπικούς σκίπερ.",
    },
    highlights: {
      en: [
    ...
    story: {
      en: "Kefalonia Day Trips was founded by local sailing enthusiasts who wanted to share the beauty of the Ionian Islands with visitors in a way that large tour operators cannot. Operating from Agia Efimia, the company has built a reputation for quality, authenticity, and exceptional guest experiences.",
      el: "Η Kefalonia Day Trips ιδρύθηκε από τοπικούς λάτρεις της ιστιοπλοΐας που ήθελαν να μοιραστούν την ομορφιά του Ιονίου με τους επισκέπτες. Με βάση την Αγία Ευφημία, η εταιρεία έχει χτίσει φήμη για ποιότητα και αυθεντικότητα.",
    },
    practicalInfo: {
      en: [
