...
export const hotels: HotelCard[] = [
  {
    ...
    features: {
      ...
      el: ["Οία (Πολυτέλεια & Εμβληματικό Ηλιοβασίλεμα)", "Ημεροβίγλι (Καλύτερες Θέες Καλδέρας)", "Φηροστεφάνι (Κρυφή Ισορροπία)", "Φηρά (Νυχτερινή Ζωή & Άνεση)", "Πύργος (Αυθεντικό Χωριό)", "Καμάρι & Περίσσα (Παραλία)", "Ακρωτήρι (Ήσυχη Καλδέρα)", "Θηρασιά (Η Πραγματική Απόδραση)"],
    },
    sections: [
      {
      ...
      },
      {
        ...
        content: {
          ...
          el: "Ο Πύργος Καλλίστης υψώνεται από το εσωτερικό της Σαντορίνης σε ένα κωνικό ηφαιστειακό λόφο, με ομόκεντρους κύκλους από λευκά σπίτια και εκκλησίες να σπειρώνονται προς ένα βενετσιάνικο κάστρο στην κορυφή — το ψηλότερο κατοικημένο σημείο του νησιού στα περίπου 350 μέτρα. Είναι το πιο άρτια διατηρημένο παραδοσιακό χωριό στη Σαντορίνη, χτισμένο ομόκεντρα ώστε να μπορεί ολόκληρος ο πληθυσμός να υποχωρεί εντός διαδοχικών αμυντικών τειχών σε περίπτωση πειρατικής επίθεσης, και διατηρεί μια αυθεντικότητα και ησυχία που τα χωριά της καλδέρας έχουν σε μεγάλο βαθμό χάσει.\n\nΗ βόλτα στον Πύργο είναι μια γνήσια διαφορετική εμπειρία από οτιδήποτε άλλο στη Σαντορίνη. Τα στενά είναι εξίσου στενά με της Οίας, αλλά χωρίς τα πλήθη — ένα κανονικό πρωί Τετάρτης τον Ιούλιο στον Πύργο σημαίνει καφέ στο τοπικό καφενείο, τη μυρωδιά αρτοποιείου από ανοιχτό παράθυρο και γάτες που κοιμούνται σε κατώφλια, χωρίς καθόλου τον ώμο-με-ώμο τουριστικό συνωστισμό των διάσημων χωριών. Το χωριό έχει πάνω από τριάντα εκκλησίες και παρεκκλήσια διαφόρων εποχών, πολλά από αυτά χτισμένα κατευθείαν στον ηφαιστειακό βράχο, και η ανάβαση μέσα από τα διαδοχικά αμυντικά δαχτυλίδια ως την κορυφή του κάστρου διαρκεί λιγότερο από είκοσι λεπτά και ανταμείβει με μια πανοραμική θέα 360° ολόκληρου του νησιού — καλδέρα δυτικά, Αιγαίο ανατολικά, ο διάδρομος αεροδρομίου και η παραλία Καμαρίου κάτω — που είναι μάλλον η καλύτερη συνολική άποψη του νησιού από ένα μόνο σημείο.\n\nΤο ηλιοβασίλεμα από τον Πύργο είναι ένα από τα πιο καλά κρυμμένα μυστικά στο νησί. Η θέα από τον κάστρο περιλαμβάνει ολόκληρη τη δυτική καλδέρα και την ανοιχτή θάλασσα πέρα από αυτήν — ένα πανόραμα που σου επιτρέπει να παρακολουθείς τον ήλιο να βυθίζεται στο νερό και το φως να αλλάζει ταυτόχρονα σε ολόκληρο το νησί, χωρίς τα πλήθη που κάνουν το σημείο του κάστρου της Οίας τόσο δύσκολο να απολαύσεις σε peak season. Το Franco's Café στη δυτική άκρη του Πύργου, ένα θρυλικό sunset bar που λειτουργεί από το 1980, σερβίρει κοκτέιλ σε βεράντα με ανεμπόδιστη θέα καλδέρας και ηλιοβασιλέματος σε ατμόσφαιρα πλήρους χαλαρής εκλέπτυνσης — ένα από εκείνα τα μέρη που οι τακτικοί επισκέπτες της Σαντορίνης αντιμετωπίζουν ως ιδιωτική ανακάλυψή τους.\n\nΤα ξενοδοχεία κοντά στον Πύργο προσφέρουν μερικές από τις πιο ήσυχες και καλύτερης αξίας επιλογές στο νησί. Το Santorini Sky — boutique ιδιοκτησία villa με ιδιωτικές πισίνες στην πλαγιά αμέσως έξω από το χωριό — προσφέρει θέα καλδέρας και θάλασσας, πλήρη ιδιωτικότητα και τιμές αισθητά χαμηλότερες από αντίστοιχες ιδιοκτησίες στην Οία ή το Ημεροβίγλι. Το Vedema Resort στο γειτονικό Μεγαλοχώρι είναι πενταστέρια ιδιοκτησία χτισμένη μέσα σε ένα αποκατεστημένο 400ετές οινοποιείο, με αμπελώνες, ιδιωτικές βίλες και spa — από τις πιο αρχιτεκτονικά ξεχωριστές πολυτελείς διευθύνσεις στις Κυκλάδες."
        }
      },
      {
        title: { en: "6. Megalochori and Emporio: The Wine Country Villages and the Medieval Heart of the Island", el: "6. Μεγαλοχώρι και Εμπορειό: Τα Χωριά της Viniculture και η Μεσαιωνική Καρδιά του Νησιού" },
        content: {
          en: "The inland villages of Megalochori and Emporio represent a Santorini that most visitors never reach — a world of vaulted wine cellars (canavas), pirate-era hidden passageways, neoclassical mansions with high-walled courtyards, and medieval fortifications that pre-date the island's tourist identity by five centuries.\n\nMegalochori is the wine village of Santorini — set in the island's principal wine-growing area, surrounded by the distinctive kouloura-trained vines (wound into low baskets to protect the grapes from the Aegean wind) that produce the extraordinary Assyrtiko white wine for which Santorini is internationally renowned. Several of the island's most celebrated wineries are within a short walk of the village: Gavalas Winery in the village itself is intimate, traditional and widely considered the most authentic wine tasting experience on the island; the restored 19th-century cave cellar and the personal attention of the family who has produced wine here for generations give it a quality that the larger, caldera-view wineries cannot replicate. Venetsanos Winery, on the caldera road above Megalochori, is built into a former tomato factory converted to spectacular effect, with a terrace suspended over the caldera that offers wine tasting with one of the finest views on the island. Art Space Winery nearby combines a working winery with an art gallery installed in 200-year-old barrel-vaulted caves — one of the most unusual and atmospheric spaces on Santorini.\n\nThe village square of Megalochori is one of those places — entirely unremarked in most guides — where the island's real social life is still visibly happening: old men playing backgammon at the kafeneion, children running between the tables, the bell of the main church marking the hours. Hidden within the village is the Heart of Santorini — a naturally carved rock formation in the shape of a heart, known to locals and to the travelers who think to look for it, invisible on any tourist map.\n\nEmporio is the largest traditional village on Santorini and the most fortified — its medieval Kasteli (castle complex) is one of five surviving Venetian fortified settlements on the island, and the maze of lanes within its walls is the most complete surviving example of the island's medieval defensive architecture. The narrow streets of Emporio wind through a living community of houses, churches and passages that have operated continuously since the 15th century. At the hill of Gavrilos above the village, the ruins of a Byzantine settlement and eight 19th-century windmills stand in remarkable preservation, with views over the southeastern corner of the island that no photograph in any Santorini guide has ever used.",
          el: "Τα εσωτερικά χωριά Μεγαλοχώρι και Εμπορειό αντιπροσωπεύουν μια Σαντορίνη που οι περισσότεροι επισκέπτες δεν φτάνουν ποτέ — έναν κόσμο θολωτών κελαριών κρασιού (καναβάδες), κρησφύγετων εποχής πειρατών, νεοκλασικών επαύλεων με ψηλόμαντρες αυλές, και μεσαιωνικών οχυρώσεων που προηγούνται κατά αιώνες της τουριστικής ταυτότητας του νησιού.\n\nΤο Μεγαλοχώρι είναι το οινικό χωριό της Σαντορίνης — στρωμένο στην κύρια αμπελοκαλλιεργητική ζώνη του νησιού, περιτριγυρισμένο από τα χαρακτηριστικά κουλουρα-εκπαιδευμένα αμπέλια (ταμπλαδένια σε χαμηλά καλάθια για προστασία σταφυλιών από τον Αιγαίο αέρα) που παράγουν τον εκπληκτικό Ασύρτικο που απολαμβάνει διεθνή φήμη. Μερικά από τα πιο φημισμένα οινοποιεία του νησιού βρίσκονται σε σύντομη απόσταση βαδίσματος: το Οινοποιείο Γαβαλά στο ίδιο το χωριό είναι οικείο, παραδοσιακό και θεωρείται ευρύτερα η πιο αυθεντική εμπειρία οινογευσιγνωσίας στο νησί. Το Οινοποιείο Βεντσάνος, στον δρόμο της καλδέρας πάνω από το Μεγαλοχώρι, χτισμένο μέσα σε πρώην εργοστάσιο τομάτας που μετατράπηκε με εντυπωσιακό αποτέλεσμα, προσφέρει οινογευσιγνωσία σε βεράντα με μια από τις καλύτερες θέες στο νησί. Το Art Space Winery κοντά συνδυάζει ένα λειτουργικό οινοποιείο με γκαλερί τέχνης εγκατεστημένη σε θολωτές σπηλαιώδεις αίθουσες 200 ετών.\n\nΚρυμμένη στο Μεγαλοχώρι βρίσκεται η Καρδιά της Σαντορίνης — ένας φυσικά σκαλισμένος βράχος σε σχήμα καρδιάς, γνωστός στους ντόπιους και στους ταξιδιώτες που σκέφτονται να ψάξουν, αόρατος σε κάθε τουριστικό χάρτη.\n\nΤο Εμπορειό είναι το μεγαλύτερο παραδοσιακό χωριό της Σαντορίνης και το πιο οχυρωμένο — το μεσαιωνικό Καστέλι του είναι ένα από τα πέντε βενετσιάνικα οχυρωμένα οικισμούς στο νησί, και ο λαβύρινθος των δρόμων εντός των τειχών του είναι το πιο ολοκληρωμένο δείγμα της μεσαιωνικής αμυντικής αρχιτεκτονικής του νησιού."
        }
      },
      {
      ...
      },
      {
        ...
        content: {
          ...
          el: "Η Θηρασιά είναι το μικρό νησί που σχηματίζει το δυτικό τόξο της καλδέρας — το τμήμα της αρχικής, προ-έκρηξης χερσονήσου που απέμεινε μετά το γεωλογικό γεγονός του 1600 π.Χ., τώρα χωρισμένο από τη Σαντορίνη από τα νερά της καλδέρας. Έχει μόνιμο πληθυσμό περίπου 200 ατόμων, χωρίς αυτοκίνητα στην προκυμαία, χωρίς μεγάλα ξενοδοχεία, χωρίς νυχτερινή ζωή, και μια ατμόσφαιρα που έμπειροι ταξιδιώτες περιγράφουν σταθερά ως αυτό που η Σαντορίνη αισθανόταν σαράντα ή πενήντα χρόνια πριν.\n\nΤο νησί είναι προσβάσιμο με τοπικό πορθμείο από την Αμμουδή της Οίας (περίπου 1-2 ευρώ μετ' επιστροφής, βάρκες τρέχουν αρκετές φορές ημερησίως το καλοκαίρι) και από τις περιηγήσεις καλδέρας που περιλαμβάνουν στάση στη Θηρασιά. Το κύριο λιμάνι είναι η Ρίβα, όπου μερικές ταβέρνες κάθονται κατευθείαν στην προκυμαία. Πάνω από τη Ρίβα, το χωριό Μανωλάς είναι μια σκληρή ανάβαση 45 λεπτών σε σκαλιά λαξευτά στη βραχώδη πλαγιά — ή μια σύντομη βόλτα με μουλάρι — με θέα πίσω προς τη βραχονησίδα της Σαντορίνης που παρέχει την καλύτερη εξωτερική θέα των χωριών της καλδέρας από οποιοδήποτε προσβάσιμο σημείο.\n\nΈνας μικρός αριθμός πανδοχείων και δωματίων για ενοικίαση στη Θηρασιά επιτρέπουν διανυκτέρευση — μια γνήσια ασυνήθιστη εμπειρία που σε τοποθετεί στην καλδέρα την αυγή με τη βραχονησίδα της Σαντορίνης ορατή απέναντι και απόλυτη σιωπή γύρω σου. Αυτό είναι το πιο ακραίο κρυφό διαμάντι της Σαντορίνης: να κοιμάσαι στην απέναντι πλευρά της καλδέρας, να παρακολουθείς το φως της ανατολής να ταξιδεύει στα λευκά κτίρια από απόσταση, χωρίς κόσμο, χωρίς θόρυβο και χωρίς τίποτε από την τουριστική υποδομή που έχει μεταμορφώσει το διάσημο νησί στο τι είναι σήμερα."
        }
      },
      {
